...
def trapezoide(a,b,n):
    """
        ...
        Salida:   Valor de la integral definida entre a y b calculado mediante el metodo del trapezoide
    """
    ans = 0
    i = (b - a)/ n
    xi = i
...
def pruebas(a,b,n):
    ...
    """
    print()
    print(" Metodo Trapezoide:")
    print(" -------------------------------------------------------------------------")
    for i in n:
        start = time()
        ans = trapezoide(a,b,i)
        elapsed = time() - start
...
def main():
    """
        ...
        intervalos en los que se integrara (n), ademas se hace el llamado a la funcion trapezoide(a,b,n) para
        solucionar la integral por el metodo del trapezoide
    """
    n = 1
    a = 0
    b = 1
